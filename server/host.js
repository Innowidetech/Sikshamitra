...
const socket = io('http://localhost:5000', {
  auth: {
    ...
    //parent
    token:'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2NzliNDQ4ZmY3Y2NmMTc0MmEzYjEwNjciLCJyb2xlIjoicGFyZW50IiwiaWF0IjoxNzQyMjgxOTM2fQ.yJ5-coffHtQZTo1v7oroAfAf_8myjvA4Er_-g6_q81s'
  },
...
socket.on('connect', () => {
  ...
  socket.emit('requestJoin', { meetingLink: 'https://meet.shikshamitra.com/69itgictv' });
});
...
setTimeout(() => {
  endMeeting('https://meet.shikshamitra.com/69itgictv');
}, 600000);
...
setTimeout(() => {
  socket.emit('chatMessage', {
    meetingLink: 'https://meet.shikshamitra.com/69itgictv',
