...
const { editTeacherProfile, getStudentsOfTeacher, assignmentForStudents, markAndUpdateAttendance, viewMonthlyAttendance, createOrUpdateTimetable, getTimetable, createOrUpdateSyllabus, getSyllabus, uploadStudyMaterial, getStudyMaterial, deleteStudyMaterial, createExams, getExams, createResults, getResults, issueBook, setBookAvailabilityTrue } = require('../controllers/teacher.controller');
const { createStudentAndParent, getProfile, createBook, deleteBook, getAllStudentsOfSchool, getBooks, getStudentById, createNotice, getNotice, deleteNotice } = require('../controllers/admin.controller');
...
router.post('/assignment', protect,authorize('teacher'), assignmentForStudents);
...
router.post('/syllabus', protect, authorize('teacher'), createOrUpdateSyllabus);
