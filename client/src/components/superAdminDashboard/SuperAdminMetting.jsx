...
const SuperAdminMetting = () => {
  ...
  const handleScheduleMeeting = () => {
    navigate("/superadmin/shedulemeeting");
  };
    ...
    <div className="h-screen w-full bg-[#FF9F1C] flex flex-col text-white relative font-sans">
      ...
      <div className="flex flex-col items-center justify-center flex-1 text-center px-4 relative">
        ...
        <h1 className="text-xl font-semibold mb-2">
          Experience seamless video calls and Meetings
        </h1>
        ...
        <div className="relative">
          <button
            ...
            className="bg-white text-orange-500 font-semibold py-2 px-4 rounded shadow flex items-center gap-2 hover:bg-orange-100 transition"
          >
            <FaVideo />
            Create meeting
...
export default SuperAdminMetting;
