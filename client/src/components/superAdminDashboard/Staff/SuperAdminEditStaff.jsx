          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-10">
            ...
            <div>
              ...
              >
                ...
                <option value="Blogs Manager">Blogs Manager</option>
        ...
        <div className="border shadow rounded-md ">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
            ...
            <div className="col-span-2 w-full p-8 ">
              <label className="text-sm  text-[16px] text-[#303972] mb-2 font-semibold block ml-4">
                Highest Education *
              </label>
...
export default SuperAdminEditStaff;
