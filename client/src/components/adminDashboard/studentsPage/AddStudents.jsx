...
function AddStudent({ isOpen, onClose, onAdd }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://sikshamitra.onrender.com/api/admin/registersp', formDataToSend, {
        headers: {
        ...
        <div className="bg-white rounded-lg w-full max-w-3xl p-4 sm:p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 overflow-y-auto max-h-[80vh]">
            <div className="p-4 rounded-lg">
              <h3 className="text-lg font-medium text-[#303972] mb-4">Student Login Details</h3>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                  <label className="block text-sm font-medium text-[#303972]">Username</label>
                  <input
                    type="text"
                    required
            ...
            <div className="p-4 rounded-lg">
              <h3 className="text-lg font-medium text-[#303972] mb-4">Parent Login Details</h3>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                  <label className="block text-sm font-medium text-[#303972]">Username</label>
                  <input
            ...
            {/* Student Profile */}
            <div className="p-4 rounded-lg">
              <h3 className="text-lg font-medium text-[#303972] mb-4">Student Profile</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-[#303972]">First Name</label>
                  <input
                    type="text"
                    required
                    className="mt-1 p-2 block w-full rounded-md border border-[#C1BBEB]"
                ...
                <div>
                  <label className="block text-sm font-medium text-[#303972]">Last Name</label>
                  <input
                    type="text"
                    required
                    className="mt-1 p-2 block w-full rounded-md border border-[#C1BBEB]"
                ...
                <div>
                  <label className="block text-sm font-medium text-[#303972]">Registration Number</label>
                  <input
                    type="text"
                    required
                    className="mt-1 p-2 block w-full rounded-md border border-[#C1BBEB]"
                ...
                <div>
                  <label className="block text-sm font-medium text-[#303972]">Class Type</label>
                  <select 
                    required
                    className="mt-1 p-2 block w-full rounded-md border border-[#C1BBEB]"
                ...
                <div>
                  <label className="block text-sm font-medium text-[#303972]">Fees</label>
                  <input
                    type="text"
                    required
                    className="mt-1 p-2 block w-full rounded-md border border-[#C1BBEB]"
            ...
            {/* Parent Profile */}
            <div className="p-4 rounded-lg">
              <h3 className="text-lg font-medium text-[#303972] mb-4">Parent Details</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-[#303972]">Father's Name</label>
                  <input
                    type="text"
                    required
                    className="mt-1 p-2 block w-full rounded-md border border-[#C1BBEB]"
                ...
                <div>
                  <label className="block text-sm font-medium text-[#303972]">Mother's Name</label>
                  <input
                    type="text"
                    required
                    className="mt-1 p-2 block w-full rounded-md border border-[#C1BBEB]"
                ...
                <div>
                  <label className="block text-sm font-medium text-[#303972]">Father's Phone</label>
                  <input
                    type="tel"
                    required
                    className="mt-1 p-2 block w-full rounded-md border border-[#C1BBEB]"
                ...
                <div>
                  <label className="block text-sm font-medium text-[#303972]">Mother's Phone</label>
                  <input
                    type="tel"
                    required
                    className="mt-1 p-2 block w-full rounded-md border border-[#C1BBEB]"
                ...
                <div>
                  <label className="block text-sm font-medium text-[#303972]">Father's Occupation</label>
                  <input
                    type="text"
                    required
                    className="mt-1 p-2 block w-full rounded-md border border-[#C1BBEB]"
                ...
                <div>
                  <label className="block text-sm font-medium text-[#303972]">Mother's Occupation</label>
                  <input
                    type="text"
                    required
                    className="mt-1 p-2 block w-full rounded-md border border-[#C1BBEB]"
                ...
                <div className="sm:col-span-2">
                  <label className="block text-sm font-medium text-[#303972]">Father's Address</label>
                  <textarea
                    required
                    rows={3}
                    className="mt-1 p-2 block w-full rounded-md border border-[#C1BBEB]"
            ...
            <div className="flex justify-end">
              <button type="submit" className="px-4 py-2 text-white bg-[#285A87] rounded-md hover:bg-[#1e4569]">
                Add Student
              </button>
            </div>
          </form>
