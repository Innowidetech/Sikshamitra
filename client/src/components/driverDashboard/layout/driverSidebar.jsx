...
const menuItems = [
  { id: 'driver-transportation', icon: LayoutDashboard, label: 'Transportation' },
  
];

const DriverSidebar = ({ setActiveSection, activeTab }) => {
  const [activeTabState, setActiveTabState] = useState(activeTab || 'driver');
