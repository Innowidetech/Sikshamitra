...
const menuItems = [
  { id: 'staffDashboard', icon: LayoutDashboard, label: 'Staff Dashboard' },
  { id: 'staffTask', icon: FaClipboardList, label: 'Task' },
  { id: 'staffQuery', icon: SiGooglebigquery, label: 'Query' }, // ✅ Corrected from 'query' to 'staffQuery'
];

const StaffSidebar = ({ setActiveSection, activeTab }) => {
  const [activeTabState, setActiveTabState] = useState(activeTab || 'staffDashboard');
    ...
    <>
      ...
      >
        ...
        <div 
          ...
          onClick={() => handleTabChange('staffDashboard')}
        >
          LOGO
        </div>
