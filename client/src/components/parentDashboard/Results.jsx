...
function Results() {
  ...
  const handleDownloadPdf = async (index) => {
    const resultDiv = document.getElementById(`result-card-${index}`);
    if (!resultDiv) return;
            ...
            <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 md:p-8">
              {filteredResults.map((resultItem, index) => (
                <div
                  ...
                  key={index}
                  className="mb-8 border border-neutral-400 p-4 sm:p-6 rounded-lg"
                >
                  ...
                  <div className="mt-4 text-right">
                    <button
                      ...
                      className="px-4 py-2 bg-[#146192] text-white rounded hover:bg-[#0f4e73] transition"
                    >
                      Download PDF
                    </button>
                  </div>
