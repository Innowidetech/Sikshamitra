...
function Contact() {
 ...
 <section className="flex flex-col md:flex-row justify-center items-stretch mx-auto max-w-4xl my-10 rounded-xl shadow-lg overflow-hidden min-h-[400px] bg-[#F5EEE4]">
  {/* Left Blue Panel */}
  <div
    className="bg-[#1982C4] text-white p-8 md:w-[40%] flex flex-col justify-start gap-4"
  ...
  {/* Right Form Panel */}
  <div
    className="bg-white md:w-[60%] p-8"
    style={{ fontFamily: "Poppins" }}
  >
