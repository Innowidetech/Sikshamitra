...
function Contact() {
 ...
 <section className="bg-[#FF9F1C] w-full px-4 flex flex-col-reverse md:flex-row items-center justify-between overflow-hidden h-[220px] md:h-[280px]">
  ...
  {/* Left Blue Panel */}
  <div className='bg-[#1982C4] text-white p-8 md:w-[35%] flex flex-col justify-center gap-4' style={{ fontFamily: 'Poppins' }}>
    <h1 className='text-xl font-semibold'>Contact Information</h1>
    <p className='text-sm'>Fill up the form and our Team will get back to you!</p>
  ...
  {/* Right Form Panel */}
  <div className='bg-white md:w-[65%] p-8' style={{ fontFamily: 'Poppins' }}>
