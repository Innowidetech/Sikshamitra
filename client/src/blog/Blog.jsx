    ...
    <>
      <section className="xl:min-w-[1440px] bg-[#FF9F1C] xl:mt-[30px] mt-[20px] flex flex-col xl:flex-row overflow-hidden max-w-full">
        <div className="p-4 xl:p-0 text-white xl:flex xl:flex-col xl:justify-center xl:ml-[69px] xl:w-[50%]">
          <h1 className="xl:text-[16px] text-md flex xl:grid xl:justify-start">
            HOME / BLOGS
          </h1>
      ...
      <section className='mt-[30px]' style={{ fontFamily: 'Poppins' }}>
        <h1 className='text-center text-xl md:text-2xl lg:text-3xl xl:text-[43px] font-semibold text-[#1982C4]'>TRENDING</h1>
          ...
          <div className="space-y-4 xl:px-10 xl:ml-[80px] md:px-4">
            <div className='relative'>
              ...
              <label className='absolute bottom-0 left-0 right-0 bg-[#FFFFFF] opacity-80 px-4 xl:w-[500px] py-2 text-xs md:text-md lg:text-lg'>
                "Effective Strategies for Enhancing Parent-Teacher Communication"
              </label>
            </div>
        ...
        <div className=" mx-4 lg:mx-10 xl:mx-0 py-6 xl:py-10">
          <div className="space-y-4 xl:px-10 xl:ml-[80px] xl:mr-[80px] md:px-4 md:flex md:justify-around">
            <div>
              <h1 className="text-lg font-medium xl:text-[47px] md:text2xl text-[#1982C4]">TOP CATEGORIES</h1>
              <hr className="my-4 border-black xl:w-[800px]" />
              <div className='lg:grid lg:grid-cols-2'>
                <div>
                  <img src={Blogimgtop} alt="Blogimgtop" />
                  <h1 className='xl:text-[25px] font-semibold xl:w-[390px] lg:text-md py-2'>"Creative Approaches to Student Engagement: Beyond the Classroom"</h1>
                  <label className='font-extralight xl:text-[23px] '>Integrate Personal Interests: Connect curriculum topics to students' hobbies and passions to enhance motivation and relevance in learning.</label>
                </div>
                <div className='lg:px-4 py-4 lg:py-0'>
                  <div>
                    <img src={Blogimgtopright2} alt="Blogimgtopright2" />
                    <label className='text-xs lg:text-lg'>"The Role of Arts Education in Fostering Creativity and Innovation"</label>
                  </div>
                  <div className='py-4'>
                    <img src={Blogimgtopright3} alt="Blogimgtopright2" />
                    <label className='text-xs lg:text-lg'>"The Role of Arts Education in Fostering Creativity and Innovation"</label></div>
                  <div className='py-4 '>
              ...
              <div className='md:flex gap-6'>
                <div>
                  <img src={BlogBoy} alt="BlogBoy" className='w-full md:w-auto object-fill' />
                </div>
                <div className='bg-[#1982C4] xl:py-14 text-white xl:px-10 xl:w-[550px] md:w-[400px] p-4' style={{ fontFamily: 'Poppins' }}>
                  <div className="mb-4">
                    <h1
                  ...
                  <h1 className='font-semibold'>"Creative Approaches to Student Engagement: Beyond the Classroom"</h1>
                  <p className='lg:py-10 text-xs font-extralight xl:text-lg'>Creative approaches to student engagement beyond the classroom involve innovative strategies that enhance learning experiences. By integrating students' personal interests and passions into lessons, educators can make learning more relevant and exciting. Additionally, experiential learning opportunities, such as field trips and community projects, provide hands-on experiences that connect classroom knowledge to real-world applications, fostering deeper understanding and engagement.</p>
                </div>
              </div>
            </div>

            <div className="border-2 border-black border-t-0 w-full p-4">
              <p className="text-lg font-semibold xl:text-[30px] text-[#1982C4] text-center xl:-translate-y-8 bg-blur">SPOTLIGHT</p>
              <div className=''>
                <div className='px-4'>
                  <img src={Blogspotimg1} alt="Blogimgtopright2" className='rounded-lg pb-2' />
                  <label className='text-xs font-light'>"The Role of Arts Education in Fostering Creativity and Innovation"</label>
                </div>
                <div className='px-4'>
                  <img src={Blogspotimg2} alt="Blogimgtopright2" className='rounded-lg pb-2' />
                  <label className='text-xs font-light'>"The Role of Arts Education in Fostering Creativity and Innovation"</label></div>
                <div className='px-4'>
                  <img src={Blogspotimg3} alt="Blogimgtopright2" className='rounded-lg pb-2' />
                  <label className='text-xs font-light'>"The Role of Arts Education in Fostering Creativity and Innovation"</label>
                </div>
                <div className='px-4'>
                  <img src={Blogspotimg4} alt="Blogimgtopright2" className='rounded-lg pb-2 ' />
                  <label className='text-xs font-light' >"The Role of Arts Education in Fostering Creativity and Innovation"</label>
                </div>
              </div>
            </div>
